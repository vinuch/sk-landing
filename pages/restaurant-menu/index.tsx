        ...
        <TabsContent value={selectedType}>
          <div className="flex gap-10 my-12 flex-wrap justify-center">
            {filteredItems.map((item) => (
              <div
                key={item.id}
                className="w-full md:w-300px rounded-lg overflow-hidden relative group cursor-pointer hover:rotate-3 transition-all ease-in-out bg-white/50 bg-cover bg-center bg-no-repeat"
                style={{
